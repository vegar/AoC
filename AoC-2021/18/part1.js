...
function explode(str, start, end) {
  console.log('before explode:'.padEnd(16, ' ') +
    chalk.yellow(str.substring(0, start)) +
    chalk.green.bold(str.substring(start,end)) +
    chalk.yellow(str.substring(end))
  )
  ...
  console.log('after explode:'.padEnd(16, ' ') +
    chalk.yellow(newStr))
...
function split(str, start, end) {
  console.log('before split:'.padEnd(16, ' ') +
    chalk.yellow(str.substring(0, start)) +
    chalk.green.bold(str.substring(start,end)) +
    chalk.yellow(str.substring(end))
  )
  ...
  console.log('after split:'.padEnd(16, ' ') + chalk.yellow(newStr))
...
const final = input.reduce((acc, curr) => {
  return add(acc, curr);
})

let result = magnitude(final);
console.log({ result })
