...
scanners.forEach((s,idx) => console.log(`Scanner ${idx}: ${s.position}`))

const allBeacons = scanners.reduce((beacons, scanner) => {
  console.log(chalk.blue(`Scanner ${scanner.scanner}`));
